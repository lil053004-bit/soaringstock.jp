    ...
    <div className="w-32 h-32 sm:w-40 sm:h-40 animate-astronaut-float">
      ...
      >
        ...
        <g className="astronaut-body">
          <rect x="70" y="90" width="60" height="70" rx="10" fill="url(#astronautGradient)" stroke="#3b82f6" strokeWidth="2" />

          <rect x="55" y="100" width="20" height="50" rx="10" fill="url(#astronautGradient)" stroke="#3b82f6" strokeWidth="2" />
          <rect x="125" y="100" width="20" height="50" rx="10" fill="url(#astronautGradient)" stroke="#3b82f6" strokeWidth="2">
            <animateTransform
          ...
          <rect x="75" y="155" width="20" height="35" rx="8" fill="url(#astronautGradient)" stroke="#3b82f6" strokeWidth="2" />
          <rect x="105" y="155" width="20" height="35" rx="8" fill="url(#astronautGradient)" stroke="#3b82f6" strokeWidth="2" />

          <circle cx="85" cy="190" r="8" fill="#475569" />
          <circle cx="115" cy="190" r="8" fill="#475569" />

          <circle cx="100" cy="60" r="35" fill="url(#helmetGradient)" stroke="#3b82f6" strokeWidth="3" />
          ...
          <path d="M 75 110 L 70 120 L 75 120" fill="none" stroke="#3b82f6" strokeWidth="2" />
          <path d="M 125 110 L 130 120 L 125 120" fill="none" stroke="#3b82f6" strokeWidth="2" />

          <circle cx="85" cy="125" r="4" fill="#3b82f6" opacity="0.6" />
          <circle cx="115" cy="125" r="4" fill="#3b82f6" opacity="0.6" />
        </g>
