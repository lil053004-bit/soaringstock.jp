    ...
    <div className="w-32 h-32 sm:w-40 sm:h-40 animate-rocket-lift">
      ...
      >
        ...
        <g className="rocket-main">
          <path d="M 100 30 L 85 60 L 85 130 L 115 130 L 115 60 Z" fill="url(#rocketBodyGradient)" stroke="#93c5fd" strokeWidth="2" />

          <ellipse cx="100" cy="30" rx="15" ry="20" fill="#60a5fa" stroke="#93c5fd" strokeWidth="2" />

          <circle cx="100" cy="80" r="12" fill="url(#rocketWindowGradient)" stroke="#3b82f6" strokeWidth="2">
            <animate attributeName="opacity" values="1;0.7;1" dur="2s" repeatCount="indefinite" />
          </circle>

          <path d="M 70 100 L 85 100 L 85 140 Z" fill="#3b82f6" stroke="#93c5fd" strokeWidth="2" />
          <path d="M 130 100 L 115 100 L 115 140 Z" fill="#3b82f6" stroke="#93c5fd" strokeWidth="2" />
