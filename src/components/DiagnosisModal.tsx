  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 backdrop-blur-sm" style={{ touchAction: 'none', background: 'rgba(45, 45, 45, 0.7)' }}>
      <div className="relative w-full max-w-3xl max-h-[90vh]">
        <div className="relative backdrop-blur-xl rounded-2xl border overflow-hidden" style={{ touchAction: 'auto', background: '#FFFFFF', borderColor: 'rgba(251, 191, 36, 0.3)', boxShadow: '0 8px 40px rgba(251, 191, 36, 0.3)' }}>
          <div
            className="sticky top-0 px-6 py-4 flex items-center justify-between border-b"
            style={{ background: 'linear-gradient(90deg, #FFF8E7, #FFFCF1)', borderColor: '#DFC6B1' }}
          >
          <div className="flex-1 text-center">
            <h2 className="text-sm font-bold text-charcoal">
              {stockName}（{stockCode}）AI情報分析レポート
            </h2>
            {isConnecting && (
        ...
        <div ref={contentRef} className="overflow-y-auto max-h-[calc(90vh-180px)] px-6 py-6" style={{ background: '#F5EDE3' }}>
          <div className="mb-6">
