      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-card-shadow p-8">
          ...
          <div className="prose max-w-none">
            <p className="text-sm text-gray-600 mb-6">最終更新日: 2025年1月28日</p>

            <section className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">1. 基本方針</h2>
              <p className="text-gray-700 leading-relaxed">
                AI株式情報分析サービス（以下「当サービス」）の運営者である株式会社マーケットインサイト（以下「当社」）は、利用者の個人情報の重要性を認識し、
            ...
            <div className="bg-slate-100 rounded-lg p-6 mt-8">
              ...
              <p className="text-sm text-gray-700 mb-2">
                <strong>代表者:</strong> 佐藤 陽介 (Yosuke Sato)
              </p>
              <p className="text-sm text-gray-700 mb-2">
                <strong>株式会社マーケットインサイト (Market Insight Co., Ltd.)</strong>
              </p>
              <p className="text-sm text-gray-700 mb-2">
                〒103-0027 東京都中央区日本橋3-14-5 日本橋テラスビル6F
              </p>
              <p className="text-sm text-gray-700 mb-2">
                電話: 03-6875-9421
              </p>
