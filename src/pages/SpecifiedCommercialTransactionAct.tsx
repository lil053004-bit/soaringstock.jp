      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-card-shadow p-8">
          ...
          <div className="space-y-6">
                ...
                <div className="flex-1">
                  ...
                  <dl className="space-y-3">
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-gray-700">株式会社サーチエンジン<br />Search Engine Co., Ltd.</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                    ...
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-gray-700">2013年7月</dd>
                    </div>
                    <div className="grid sm:grid-cols-3 gap-2">
                      <dt className="font-semibold text-gray-900">業種</dt>
                      <dd className="sm:col-span-2 text-gray-700">SEO／デジタルマーケティング／広告運用</dd>
                    </div>
                  </dl>
                </div>
              </div>
                ...
                <div className="flex-1">
                  ...
                  <dl className="space-y-3">
                    <div className="grid sm:grid-cols-3 gap-2">
                      ...
                      <dd className="sm:col-span-2 text-blue-600">support@soaringstock.jp</dd>
                    </div>
                  </dl>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-lg p-5">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start gap-2">
                    ...
                    <span>公開市場データに基づく株式情報の集約・表示</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span>株価チャート、市場データの可視化</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span>AIによる市場データ分析レポートの生成</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-600 mt-1">•</span>
                    <span>参考情報の提供（特定銘柄の売買推奨や投資助言ではありません）</span>
                  </li>
                </ul>
              </div>
            </section>
            ...
            <section className="border-b border-gray-200 pb-6">
              ...
              <div className="bg-slate-50 rounded-lg p-5">
                <p className="text-gray-700 leading-relaxed">
                  ...
                  AI分析結果の生成には、通常数秒から数十秒程度のお時間をいただきます（サーバー状況により変動する場合があります）。
                </p>
              </div>
            </section>
            ...
            <section className="border-b border-gray-200 pb-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4">返品・交換について</h2>
              <div className="bg-slate-50 rounded-lg p-5">
                <p className="text-gray-700 leading-relaxed mb-3">
                  本サービスはデジタルコンテンツによる情報提供サービスであり、
                  サービスの性質上、返品・交換には対応しておりません。
                </p>
                <p className="text-gray-700 leading-relaxed">
                  サービス内容に関するご質問は、
              ...
              <div className="bg-amber-50 border-l-4 border-amber-500 p-5 rounded-r-lg">
                ...
                <div className="space-y-2 text-gray-700 text-sm leading-relaxed">
                  ...
                  <p>
                    ...
                    投資元本を失う可能性があります。過去の分析結果や運用実績は将来の運用成果を保証するものではありません。
                  </p>
                  <p>
