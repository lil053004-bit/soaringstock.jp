...
const LoadingFallback = () => (
  <div className="flex items-center justify-center bg-beige-bg" style={{ minHeight: '100vh' }}>
    <div className="text-center">
      <div className="inline-block animate-spin rounded-full h-12 w-12 border-b-2 border-yellow-primary mb-4"></div>
      <p className="text-charcoal text-lg">読み込み中...</p>
    </div>
  </div>
);
